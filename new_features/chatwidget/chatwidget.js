                ...
                <div class="chat-content">
                    ...
                    <section class="my-text-white my-py-6 my-px-4 my-flex my-flex-col my-items-center my-space-y-6" id="interactive-live-demo">
                        <div class="my-w-full my-max-w-2xl">
                            <h2 class="my-text-3xl my-font-bold my-text-center my-mb-2 my-text-accent">Pathway-AI</h2>
                            <p class="my-text-center my-mb-4">Experience the power of Intelligent Digital Assistants.</p>
                                    ...
                                    <div class="my-p-6 my-rounded-lg my-shadow-lg my-transition-shadow my-hover-shadow-xl" id="demo-card">
                                        <div class="card my-mt-6">
                                            ...
                                            <form id="upload-form" class="my-space-y-3">
                                                <div id="file-and-upload" class="my-flex my-items-center my-space-x-3 my-justify-center">
                                            ...
                                            <div id="still-working-text" class="still-working hidden">
                                                <p>Still working...</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="query-container" class="my-mt-6 hidden">
                                <div class="my-flex my-justify-center my-text-center">
                                    <div class="my-w-full my-max-w-2xl my-mx-auto">
                                        <div id="terminal" class="my-bg-dark my-p-6 my-rounded-lg my-transition-shadow my-hover-shadow-xl my-text-center">
                                            ...
                                            <div class="my-justify-center my-text-center" id="loading-container" style="display: none;">
